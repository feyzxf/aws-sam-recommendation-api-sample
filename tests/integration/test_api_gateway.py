...
class TestApiGateway(TestCase):
    ...
    def setUp(self) -> None:
        ...
        here we use cloudformation API to find out what the ContentRecommendationApi URL is
        """
        ...
        api_outputs = [output for output in stack_outputs if output["OutputKey"] == "ContentRecommendationApi"]
        self.assertTrue(api_outputs, f"Cannot find output ContentRecommendationApi in stack {stack_name}")
